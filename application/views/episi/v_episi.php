...
<section class="content">
    <div class="container-fluid">
      <div class="row row-md">
          <div class="col-md-6">
              <div class="card p-3">
                  <p>Data Pegawai Episi</p>

                  <p>Data Pegawai ini diurutkan berdasarkan: </p>
                  <ul>
                      <li>Data karyawan yang belum melewati hari ini akan ditampilkan di urutan atas (yang kontraknya paling dekat di urutan teratas).</li>
                      <li>Data karyawan yang masa kontraknya sudah melewati hari ini akan ditampilkan di urutan bawah.</li>
                  </ul>
              </div>
          </div>
          <div class="col-md-6">
...
<div class="row row-md">
    <div class="card p-4">
      <div class="card-header" > 
        <h5 class="text-center ">Data Pegawai Episi</h5>
    ...
    <div class="card-body table table-responsive p-3">
