    ...
    <div class="container-fluid">
      ...
      <div class="col-md-6">
        <div class="card text-bg-light shadow">
            <div class="card-header bg-primary">
                Cari pegawai
                <a href="<?= base_url('PttReguler');?>" class="btn btn-warning float-end" type="button">
            ...
            <div class="card-body">
                <form method="POST" action="<?= base_url('PttReguler/search'); ?>">
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Cari pegawai berdasarkan nama, unit organisasi/ jabatan" name="keyword">
